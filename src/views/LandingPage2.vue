        ...
        <div class="search-box">
            <div class="search-line">
                ...
                <div class="search-line-input">
                    <input type="text" name="" id="" placeholder="Digite sua cidade ou estado">
                </div>
            </div>
            <div class="search-line">
            ...
            <div class="search-line">
                ...
                <div class="search-line-input"><input type="date" name="" value="" ></div>

            </div>
            <RouterLink class="btn btn-primary btn-search" to="/viagens">Pesquisar viagens solidárias</RouterLink>
        </div>
    </div>
